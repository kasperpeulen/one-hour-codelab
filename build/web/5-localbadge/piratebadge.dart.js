...
z=this.Jc()
if(z==null){if(init.globalState.yc!=null&&init.globalState.i2.x4(0,init.globalState.yc.jO)&&init.globalState.Ai===!0&&init.globalState.yc.Gx.hr===0)H.Vj(P.FM("Program exited with open ReceivePorts."))
y=init.globalState
...
T9:[function(a){return J.kI(a)},"$1","rm",2,0,3],
...
H.VM(new W.xC(0,z.J6,z.fA,W.VF(A.qC()),z.el),[H.Kp(z,0)]).DN()
z=document.querySelector("#generateButton")
$.Tn=z
z=J.Vg(z)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(A.OL()),z.el),[H.Kp(z,0)]).DN()
A.Qx(A.dK())},"$0","KW",0,0,1],
...
KL:[function(a){A.Qx(A.ly(null,null))},"$1","OL",2,0,6],
Qx:function(a){var z
if(a==null)return
z=document.querySelector("#badgeName")
z.textContent=J.FN(a.zn)===!0?"":H.d(a.zn)+" the "+H.d(a.c8)
window.localStorage.setItem("pirateName","{ \"f\": \""+H.d(a.zn)+"\", \"a\": \""+H.d(a.c8)+"\" } ")},
dK:function(){var z,y
...
init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"WW",void:true,args:[W.ea]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"uO",args:[P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
